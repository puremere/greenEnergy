...
namespace greenEnergy.Model.pals  // اینجا عوض شه
{
    //2a3a78e5-2d20-4928-bf8b-c8abc6d93702

    //d409920a-49b7-4225-bfe3-201bf7cb3a0d
    class Context : DbContext
    {

        public Context() : base("pals") // NfcDb green2
        {
            // اینجا عوض شه
