...
namespace greenEnergy.ViewModel
{
    ...
    public class poseparent
    {
        ...
        public poseViewVM top2top { get; set; }
        public poseViewVM bottom2bottom { get; set; }
        public poseViewVM lead2lead { get; set; }
        public poseViewVM trail2trail { get; set; }
        public poseViewVM top2bottom { get; set; }
        public poseViewVM bottom2top { get; set; }
        public poseViewVM trail2lead { get; set; }
        public poseViewVM lead2trail { get; set; }
        public bool centerX { get; set; }
        public bool centerY { get; set; }
    }

    public class poseViewVM
    {
    ...
    public class formFullDetailItemVM : formItemVM
    {
        ...
        public List<formFullDetailItemVM> stringImageCollection { get; set; }
    }
    ...
    {
        public List<processVM> processList { get; set; }
        public List<newOrderVM> orderList { get; set; }
    }
