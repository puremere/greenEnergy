...
namespace greenEnergy.BankMellatLibrary
{
    public class BankMellatImplement
    {
        ...
        public BankMellatImplement(string callbackURL, long teminalID, string username, string Pass)
        {
            try
            {
                terminalId = teminalID;
