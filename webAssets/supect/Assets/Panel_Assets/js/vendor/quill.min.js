...
!(function (t, e) {
    ...
    return (function (t) {
        ...
        function (t, e, n) {
            ...
            function i(t, e) {
                if (((e = (0, k["default"])(!0, { container: t, modules: { clipboard: !0, keyboard: !0, history: !0 } }, e)), null == e.theme || e.theme === T.DEFAULTS.theme)) e.theme = N["default"];
                ...
                return (
                    null != e.modules && null != e.modules.toolbar && e.modules.toolbar.constructor !== Object && (e.modules.toolbar = { container: e.modules.toolbar }),
            ...
            function l(t, e, n, r, o) {
                ...
                return (
                    ...
                    "object" === ("undefined" == typeof n ? "undefined" : s(n)) ? ((i = n), (o = r)) : "string" == typeof n && (null != r ? (i[n] = r) : (o = n)),
                                ...
                                value: function (t, e) {
                                    ...
                                    if ("string" != typeof t) {
                                        ...
                                        null == this.imports[t] || r || q.warn("Overwriting " + t + " with", e),
                                            (this.imports[t] = e),
                                            (t.startsWith("blots/") || t.startsWith("formats/")) && "abstract" !== e.blotName && _["default"].register(e);
                                },
                            },
                        ]),
                        c(t, [
            ...
            (T.DEFAULTS = { bounds: document.body, formats: null, modules: {}, placeholder: "", readOnly: !1, theme: "default" }),
                (T.events = v["default"].events),
                (T.sources = v["default"].sources),
                (T.version = "1.0.0"),
                (T.imports = { delta: h["default"], parchment: _["default"], "core/module": g["default"], "core/theme": N["default"] }),
                (e.expandConfig = i),
                (e.overload = l),
                (e["default"] = T);
        },
            ...
            n.classList.toggle("test-class", !1),
                ...
                Object.defineProperty(Array.prototype, "find", {
                    value: function r(t) {
                        ...
                        for (var r, e = Object(this), n = e.length >>> 0, o = arguments[1], i = 0; i < n; i++) if (((r = e[i]), t.call(o, r, i, e))) return r;
                    },
                }),
                        ...
                        case h:
                            r + o > 1
                                ? (0 !== r &&
                                    0 !== o &&
                                    ((e = l(s, i)),
                                        0 !== e && (n - r - o > 0 && t[n - r - o - 1][0] == h ? (t[n - r - o - 1][1] += s.substring(0, e)) : (t.splice(0, 0, [h, s.substring(0, e)]), n++), (s = s.substring(e)), (i = i.substring(e))),
                                        (e = a(s, i)),
                                        0 !== e && ((t[n][1] = s.substring(s.length - e) + t[n][1]), (s = s.substring(0, s.length - e)), (i = i.substring(0, i.length - e)))),
                                    0 === r ? t.splice(n - o, r + o, [f, s]) : 0 === o ? t.splice(n - r, r + o, [c, i]) : t.splice(n - r - o, r + o, [c, i], [f, s]),
                ...
                for (n = 1; n < t.length - 1;)
                    t[n - 1][0] == h &&
                        ...
                        (t[n][1].substring(t[n][1].length - t[n - 1][1].length) == t[n - 1][1]
                            ? ((t[n][1] = t[n - 1][1] + t[n][1].substring(0, t[n][1].length - t[n - 1][1].length)), (t[n + 1][1] = t[n - 1][1] + t[n + 1][1]), t.splice(n - 1, 1), (p = !0))
                            : t[n][1].substring(0, t[n + 1][1].length) == t[n + 1][1] && ((t[n - 1][1] += t[n + 1][1]), (t[n][1] = t[n][1].substring(t[n + 1][1].length) + t[n + 1][1]), t.splice(n + 1, 1), (p = !0))),
                        n++;
                p && u(t);
            }
            var c = -1,
                ...
                return t.ops.reduce(function (t, e) {
                    ...
                    if (
                        (null == e.attributes ||
                            ...
                            ((e = (0, j["default"])(e)), e.attributes.list ? (e.attributes.list = "ordered") : ((e.attributes.list = "bullet"), delete e.attributes.bullet)),
                                ...
                                value: function (t) {
                                    ...
                                    if (
                                        (1 === r.length && "characterData" === r[0].type && g["default"].find(r[0].target)
                                            ...
                                            : ((this.delta = this.getDelta()), (t && (0, N["default"])(o.compose(t), this.delta)) || (t = o.diff(this.delta))),
                                            t.length() > 0)
                                    ) {
                                        var i,
            ...
            (r.prototype._events = void 0),
                ...
                (r.prototype.removeListener = function (t, e, n, r) {
                    ...
                    if (e)
                        ...
                        else for (var s = 0, u = l.length; s < u; s++) (l[s].fn !== e || (r && !l[s].once) || (n && l[s].context !== n)) && a.push(l[s]);
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    if (!this.selection.composing && null != this.parent) {
                                        for (var n = this.textNode, r = this.selection.getNativeRange(); null != this.domNode.lastChild && this.domNode.lastChild !== this.textNode;)
                        ...
                        s(t, [
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    return { left: r.left - m.left, right: r.left + r.width - m.left, top: r.top - m.top, bottom: r.top + r.height - m.top, height: r.height, width: r.width };
                                },
                            },
                            {
                                key: "getNativeRange",
                                value: function () {
                                    ...
                                    var n = { start: { node: e.startContainer, offset: e.startOffset }, end: { node: e.endContainer, offset: e.endOffset }, native: e };
                                    return (
        ...
        function (t, e, n) {
            ...
            (F.DEFAULTS = { matchers: [] }), (e["default"] = F), (e.matchAttributor = p), (e.matchBlot = d), (e.matchNewline = b), (e.matchSpacing = g), (e.matchText = _);
        },
        function (t, e, n) {
            "use strict";
            function r(t) {
        ...
        function (t, e, n) {
            ...
            var o = n(2),
                i = r(o),
                l = new i["default"].Attributor.Class("size", "ql-size", { scope: i["default"].Scope.INLINE, whitelist: ["small", "large", "huge"] }),
                a = new i["default"].Attributor.Style("size", "font-size", { scope: i["default"].Scope.INLINE, whitelist: ["10px", "18px", "32px"] });
                            ...
                            },
                            {
                                ...
                                value: function (t, e) {
                                    if (0 !== t.ops.length) {
                                        ...
                                        this.stack.undo.push({ redo: t, undo: n }), this.stack.undo.length > this.options.maxStack && this.stack.undo.unshift();
                                    }
                                },
                            },
                            {
                                            ...
                                            if (0 !== o.length) {
                                                ...
                                                if (null != i) {
                                                    var l = t.quill.scroll.line(i.index),
                                                        ...
                                                        k = { collapsed: 0 === i.length, empty: 0 === i.length && s.length() <= 1, format: t.quill.getFormat(i), offset: u, prefix: O, suffix: w },
                                                        E = o.some(function (e) {
                        ...
                        "list autofill": {
                            ...
                            handler: function (t, e) {
                                ...
                                this.quill.scroll.deleteAt(t.index - n, n),
                                    this.quill.formatLine(t.index - n, 1, "list", 1 === n ? "bullet" : "ordered", E["default"].sources.USER),
                ...
                (E.DEFAULTS = {
                    ...
                    handlers: {
                        ...
                        direction: function (t) {
                            ...
                            "rtl" === t && null == e ? this.quill.format("align", "right", m["default"].sources.USER) : t || "right" !== e || this.quill.format("align", !1, m["default"].sources.USER),
        ...
        function (t, e, n) {
            ...
            (_.TEMPLATE = ['<span class="ql-tooltip-arrow"></span>', '<div class="ql-tooltip-editor">', '<input type="text" data-formula="e=mc^2" data-link="quilljs.com" data-video="Embed URL">', '<a class="ql-close"></a>', "</div>"].join(
                ""
            )),
                (e["default"] = m);
        },
                        ...
                        var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n)),
                            l = function a(e) {
                                return document.body.contains(t.root)
                                    ? (null == r.tooltip || r.tooltip.root.contains(e.target) || document.activeElement === r.tooltip.textbox || r.quill.hasFocus() || r.tooltip.hide(),
                                        void (
                                            null != r.pickers &&
                                        ...
                                        n.addEventListener("change", function () {
                                            if (null != n.files && null != n.files[0]) {
                                                ...
                                                (t.onload = function (t) {
                                                    ...
                                                    e.quill.updateContents(new p["default"]().retain(r.index)["delete"](r.length).insert({ image: t.target.result }), y["default"].sources.USER), (n.value = "");
                                                }),
                            ...
                            value: function () {
                                ...
                                switch (this.root.getAttribute("data-mode")) {
                                    case "link":
                                        ...
                                        this.linkRange ? (this.quill.formatText(this.linkRange, "link", t, y["default"].sources.USER), delete this.linkRange) : (this.restoreFocus(), this.quill.format("link", t, y["default"].sources.USER)),
        ...
        function (t, e, n) {
            ...
            var a = (function () {
                ...
                g = n(100),
                m = (r(g), n(40)),
                _ = [[{ header: ["1", "2", "3", !1] }], ["bold", "italic", "underline", "link"], [{ list: "ordered" }, { list: "bullet" }], ["clean"]],
                O = (function (t) {
                    function e(t, n) {
